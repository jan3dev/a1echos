  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 40),
          child: _ClearIconDemoSection(
            title: 'Clear Icon Demo',
            controller: controller,
          ),
        ),
        const SizedBox(height: 32),
...
class _ClearIconDemoSection extends HookConsumerWidget {
  const _ClearIconDemoSection({
    required this.controller,
    required this.title,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final onClearCallback = useCallback(() {
      AquaTooltip.show(
        context,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 24),
          AquaTextField(
            label: 'TextField with Clear Icon',
            controller: controller,
            showClearIcon: true,
          ...
          const SizedBox(height: 12),
          AquaTextField(
            label: 'TextField with Clear + Paste Icons',
            controller: controller,
            trailingIcon: pasteIcon,
            onTrailingTap: onCopyTap,
            showClearIcon: true,
            onClear: onClearCallback,
          ),
          const SizedBox(height: 12),
          AquaTextField(
            label: 'TextField with only Paste Icon',
            controller: controller,
            trailingIcon: pasteIcon,
            onTrailingTap: onCopyTap,
            showClearIcon: false,
