...
class AquaTextField extends HookWidget {
  ...
  static const kClearIconSpacing = 16.0;
            ...
            child: AnimatedContainer(
              ...
              child: Stack(
                ...
                children: [
                      ...
                      builder: (context, constraints) => TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.fromLTRB(
                            ...
                            _calculateTrailingPadding(hasText.value),
                            kContentVerticalPadding,
                          ),
                          isDense: true,
                          labelText: null,
                  ...
                  // Trailing Widgets
                  if (showClearIcon && hasText.value ||
                      trailingIcon != null) ...{
                    if (showClearIcon &&
                        hasText.value &&
                        trailingIcon != null) ...{
                      // Both clear icon and trailing icon present
                      Positioned(
                        right: kTrailingIconRightPosition + kClearIconSpacing + 18.0,
                        top: 0,
                        bottom: 0,
                    ...
                    } else if (showClearIcon && hasText.value) ...{
                      // Only clear icon present
                      Positioned(
                        right: kTrailingIconRightPosition,
                        top: 0,
                        bottom: 0,
  ...
  /// Helper method to calculate trailing padding based on icons
  double _calculateTrailingPadding(bool hasText) {
    final hasClearIcon = showClearIcon && hasText;
    final hasTrailingIcon = trailingIcon != null;

    if (hasClearIcon && hasTrailingIcon) {
      // Both icons present: need space for both + spacing
      return kTrailingIconPadding + 18.0 + kClearIconSpacing;
    } else if (hasClearIcon || hasTrailingIcon) {
      // Only one icon present
      return kTrailingIconPadding;
    } else {
      // No icons
      return kContentTrailingPadding;
    }
  }

  /// Helper method to create the clear icon widget
