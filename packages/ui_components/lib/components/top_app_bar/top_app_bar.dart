  ...
  const AquaTopAppBar({
    ...
    this.actions = const [],
        ...
        assert(
          ...
          'Either showBackButton must be true or leading widget must be provided',
        ),
        assert(
          !(showBackButton && leading != null),
          'showBackButton and leading cannot be used together',
        );
            ...
            children: [
              Row(
                children: [
                  ...
                  AquaUiAssets.svgs.echosLogo.svg(
