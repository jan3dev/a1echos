...
///
/// ```dart
/// import 'gen/ui_localizations.dart';
///
/// return MaterialApp(
...
abstract class UiLocalizations {
  ...
  /// No description provided for @failedToShareQrImage.
  ///
  /// In en, this message translates to:
  /// **'Failed to share QR image'**
  String get failedToShareQrImage;

  /// No description provided for @onlyForAsset.
  ///
  /// In en, this message translates to:
  /// **'Only for {asset}'**
  String onlyForAsset(String asset);

  /// No description provided for @singleUseAddress.
  ///
  /// In en, this message translates to:
  /// **'Single Use Address'**
  String get singleUseAddress;

  /// No description provided for @expOrderExpireDate.
  ///
  /// In en, this message translates to:
  /// **'Exp: {orderExpiresatFormatfulldate}'**
  String expOrderExpireDate(String orderExpiresatFormatfulldate);

  /// No description provided for @swapServiceFee.
  ///
  /// In en, this message translates to:
  /// **'Swap Service Fee'**
  String get swapServiceFee;

  /// No description provided for @usdtSentHereIsSwappedToLiquidUsdt.
  ///
  /// In en, this message translates to:
