...
export const AquaTypography = {
  ...
  body1: createTypographyVariant(INTER, "body1"),
  body2: createTypographyVariant(INTER, "body2"),
  caption1: createTypographyVariant(INTER, "caption1", false),
  caption2: createTypographyVariant(INTER, "caption2", false),
  ...
  body1Medium: createTypographyVariant(INTER_MEDIUM, "body1"),
  body2Medium: createTypographyVariant(INTER_MEDIUM, "body2"),
  caption1Medium: createTypographyVariant(INTER_MEDIUM, "caption1", false),
  caption2Medium: createTypographyVariant(INTER_MEDIUM, "caption2", false),
  ...
  body1SemiBold: createTypographyVariant(INTER_SEMIBOLD, "body1"),
  body2SemiBold: createTypographyVariant(INTER_SEMIBOLD, "body2"),
  caption1SemiBold: createTypographyVariant(INTER_SEMIBOLD, "caption1", false),
  caption2SemiBold: createTypographyVariant(INTER_SEMIBOLD, "caption2", false),
} as const;
